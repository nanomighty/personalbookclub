        ...
        axios.get("http://localhost:8000/api/book")
            .then((res) => {
                setAllBooks(allBooks.filter((book) => 
                    ...
                    // Book.find({
                    //     $or : [
                    //         {bookTitle: searchValue},
                    //         {bookAuthor: searchValue},
                    //         {genre: searchValue}
                    //     ]
                    // });
        ...
        <div>
            <div className="topnav">
                <div style={{"display": "flex", "justifyContent": "center"}}>
                    <input onChange = {(e) => setSearchValue(e.target.value)} style={{"margin": "auto 5px", "width": "90%", "height": "30px", "borderRadius": "10px"}} type="text" placeholder="Title, Author, or Genre"></input> 
                    <svg onClick={ () => onSearchHandler()} style={{"margin": "auto 5px"}} xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" class="bi bi-search" viewBox="0 0 16 16">
